...
<body>
	<h1 class="mx-3">JAYA KOMPUTER</h1>
			...
			<div class="row">
							...
							<div class="form-group row">
								...
								<div class="col-8">
									<div class="custom-control custom-radio custom-control-inline">
										...
										<label for="produk_0" class="custom-control-label">LCD LAPTOP</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
										<input name="produk" required id="produk_1" type="radio" class="custom-control-input" value="TV">
										<label for="produk_1" class="custom-control-label">MONITOR</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
				...
				<div class="col-4">
					<div class="list-group position-relative">
						...
						<button type="button" class="list-group-item list-group-item-action">LCD LAPTOP: 2.000.000</button>
						<button type="button" class="list-group-item list-group-item-action">MONITOR: 5.000.000</button>
